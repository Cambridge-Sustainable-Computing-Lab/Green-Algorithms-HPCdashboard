...
DEFAULT_GRAFANA_DASHBOARD_FOLDER="Green Algorithms"
...
DEFAULT_INFRASTRUCTURE_DIR="samples"
DEFAULT_DATASOURCE_NAME="demo_datasource"
...
grafana_dashboard_folder=$DEFAULT_GRAFANA_DASHBOARD_FOLDER
...
common_users_file="$repo_root_dir/ga_dashboard/samples/common_users_list.csv"
...
python $repo_root_dir/frontend/import_users.py --input_file $common_users_file \
    ...
    --dashboard_folder "$grafana_dashboard_folder"
echo "\n* Done! *\n"
...
sh $repo_root_dir/ga_dashboard/run_backend.sh --db_name $db_name --db_user $db_user --db_password $db_password  \
    -S $start_date -E $end_date --useOtherInfrastructureInfo $infrastructure_dir --useCustomLogs samples/sacct_output_single_user.txt
echo "\n* Done! *\n"
...
python $repo_root_dir/frontend/import_dashboards.py --input_dir . --admin_password $grafana_admin_password
exit
