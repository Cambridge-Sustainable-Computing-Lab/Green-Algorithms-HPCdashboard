...
*PUE*, the efficiency coefficient of the data centre, is defined in the paper as *PUE* = *P*<sub>total</sub> / *P*<sub>compute</sub>. The ideal value is 1.0, meaning that all power supplied to the building is used by computing equipment. As a simplifying assumption, we set *PUE* to 1.

Thus: 

Energy used by core = *t* x *n*<sub>c</sub> *P*<sub>c</sub> *u*<sub>c</sub> x *PUE* x 0.001

= 0.2252777777777778 x 5 x 9.4 x 1 x 0.001

= 0.010588055555555557 kWh

The value of *n*<sub>m</sub>, memory available, corresponds to the `sacct` output quantity `ReqMem`, and is 60150M = 60.150 GB.

*P*<sub>m</sub>, the power draw of the memory, is found by consulting the file `ga_dashboard/data/fixed_parameters.yaml`. This tells uis that `power_memory_perGB: 0.3725` in Watts per GB.

Thus:

Energy used by memory = *t* x *n*<sub>m</sub> *P*<sub>m</sub> x *PUE* x 0.001

= 0.2252777777777778 x 60.150 x 0.3725 x 1 x 0.001

= 0.005047545729166667 kWh
